<?php 
    ...
    $open = "category";
    // _debug($sub);die;
    $sqlCate    =   "SELECT * FROM category WHERE id_store = $id_store AND `key` = 0";
    // _debug($sqlCate);die;
    $category = $db->fetchsql($sqlCate);
    if(isset($_GET['page'])){
        $p = $_GET['page'];
    }
    else{
    ...
    $sql = "SELECT * FROM product WHERE id_store = $id_store";
    // _debug($sql);die;
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                    <div class="filter-widget">
                        <h4 class="fw-title">Tất cả danh mục</h4>
